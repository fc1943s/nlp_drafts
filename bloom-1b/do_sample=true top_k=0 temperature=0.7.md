...
To better depict this topic, we will use a simple example - take a look at the following code snippet:
#include <iostream>
#include <string>
#include <vector>
#include <functional>
...
int main()
{
    ...
    std::function<std::pair<std::string, std::string>(std::string, std::string)> who = [&](std::string name, std::string address) {
    ...
    std::function<std::vector<std::string>> filter = [&](std::string s) {
        if (s == name || s == address) {
            actual.push_back(s);
            return true;
        };
    ...
    std::function<std::vector<std::string>> filter2 = [&](std::string s) {
        if (s == "Tom") {
            actual.push_back(address);
            return true;
        };
        return false;
    };

    std::function<std::vector<std::string>> filter3 = [&](std::string s) {
        if (s == "Tom" && s == address) {
    ...
    std::function<std::vector<std::string>> filter4 = [&](std::string s) {
        if (s == address && s == name) {
            actual.push_back(address);
            return true;
        };
    ...
    std::function<std::vector<std::string>> filter5 = [&](std::string s) {
        if (s == address && s == name && s == address && s == name) {
            actual.push_back(address);
            return true;
        };
        return false;
    ...
    std::function<std::vector<std::string>> filter6 = [&](std::string s) {
        if (s == address && s == name && s == address && s == name && s == address && s == address && s == name && s == address) {
            actual.push_back(address);
            return true;
        };
        return false;
    ...
    std::function<std::vector<std::string>> filter7 = [&](std::string s) {
        if (s == address && s == name && s == address && s == name && s == address && s == name && s == address && s == name && s == address && s == address && s == name && s == address && s == address && s == name && s == address && s == address) {
            actual.push_back(address);
            return true;
        };
        return false;
    ...
    std::function<std::vector<std::string>> filter8 = [&](std::string s) {
        if (s == address && s == name && s == address && s == name && s == address && s == address && s == name && s == address && s == name && s == address && s == name && s == address && s == name && s == address && s == address && s == name && s == address && s == address && s == name && s == address && s == address && s == name && s == address) {
            actual.push_back(address);
            return true;
        };
        return false;
    ...
    std::function<std::vector<std::string>> filter9 = [&](std::string s) {
        if (s == "Tom" && s == address) {
            actual.push_back(address);
            return true;
        };
    ...
    std::function<std::vector<std::string>> filter10 = [&](std::string s) {
        if (s == "Tom" && s == address && s == name) {
            actual.push_back(address);
            return true;
        };
        return false;
    ...
    std::function<std::vector<std::string>> filter11 = [&](std::string s) {
        if (s == "Tom" && s == address && s == address && s == "Tom" && s == address) {
            actual.push_back(address);
            return true;
        };
        return false;
...
To better depict the fantasy world of the Magician's Apprentice, we will use the following pictures from a book by the same name by the same author:

Why do you think the magician's apprentice is so successful? Because he is able to create aesthetically pleasing objects out of nothing. Without the power of imagination, he would be unable to create any such objects.

Why do you think the magician's apprentice is able to create anything? Because the magician's apprentice pays very close attention to the creation process. He would spend hours creating objects from nothing. He could spend his entire day thinking about how he could create an object, or how he could make a part of an object come together. He would spend hours and hours making models of his objects in his mind, which would enable him to create new objects every day. He would also spend hours making models of his objects, which would enable him to know where the parts of the object are. He could even make models of his objects, which would enable him to know how they work and how they interact with each other.
