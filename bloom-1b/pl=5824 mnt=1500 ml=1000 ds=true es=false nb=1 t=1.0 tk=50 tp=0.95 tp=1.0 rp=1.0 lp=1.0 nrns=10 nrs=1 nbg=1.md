...
Yes, ultimately, the universe is only 3+1 dimensional. That's the fundamental physical assumption for the universe that we all live within. However, as I stated above, the question of how to describe the physical world in an 4D universe remains a mystery.
...
As this particle continues moving around the 3+1 rotational axis, it would first experience 3+1 rotational acceleration. This 3+1 rotational acceleration would cause it to make a right angle with the z-boundary and then turn around, creating the effect we see above.
...
When Alice was ready to give birth to the baby, she had to decide where to bring the newborn. Fred suggested that they take the baby outside to the village to live. Fred had known that Alice had a passion for animals and so he would be happy to care for the baby. Alice could tell by the look on the baby's face that it had loved the experience. Alice then gave birth to the baby and she felt great and happy. The baby was so well looked after that only four days later, after it was three months old, the baby was taken to see the King of France. Fred kept asking Alice to keep the baby until the baby was three months, but Alice refused.
...
Finally, we should note that not everyone in the human population shares the same mathematical skills and abilities. Mathematics is a skill for any individual in the human population, but the ability to solve mathematical problems is more likely to come from some individuals.
...
The process of intelligence is the same in all three forms - that is, we start at the highest level of the pyramid and then follow the progress all the way down - the process that most people associate with intelligence.
...
So, in the end, you will have to lead the group through the final crisis together. You'll have to solve this crisis and determine who is going to be the next in line for the group to dissolve, which I suggest would be you!
...
So for instance, the kids in the lower dimension were brought up in their own lower dimension (in the form of their mothers), so they didn't develop any hallucinations or illusions when traveling from their mothers dimension to their own. In the higher dimension the children did develop strange and beautiful illusions when traveling back to the original dimension, because their mothers now had more information about their own dimension (as they traveled back from their original dimension to the higher dimension).
...
The Meadow Mage is located on the edge of the Meadow - a vast agricultural area - that is surrounded by mountains and farmlands. It is situated on an island that is surrounded by the ocean and is connected by a narrow sandy road to the mainland of the island. This road leads to the Meadow itself, and is approximately 300 meters long.
...
Yes, ultimately, the only way to make up for any loss of knowledge about what is going on at the subatomic level is by using that knowledge in the physical world. You can see in the last chapter that many physicists are interested in the subatomic phenomena because they have lost touch with the real world...we have all experienced this feeling one time or another. However, the subatomic world is far from our perception of normal reality.

The subatomic world is the smallest level of reality, which can be explored and understood using the principles of physics. And so, one of the great mysteries of physics - and one that many physicists have tried to resolve - is how it is possible for objects to gain energy from other things and store it at different parts of their bodies at the same time without losing any of their energy.

This last mystery is often referred to as the "Big Bang" problem - the fact that no one has managed to fully explain this phenomenon.

This mystery can be tackled using the principle of relativity. It goes like this: imagine that you have three separate subatomic particles that travel throughout the ether - these are the subatomic clocks, which give us a sense of time and are governed by laws of physics, but they don't have the capacity for storing energy from other things. And they don't need to, since they travel in their own inertial frames. But still, they get lost and stop trying to keep track of time because it takes them way too long to do so. They eventually fall back into the big bang, which explains why no one has yet managed to fully understand why these subatomic particles can do this without losing their energy!

I can't get enough of this concept!

It's not long before another mystery pops up: what is the origin of space and time? Well, I think that's a pretty easy answer to this question - in physics, we basically have three dimensions of space, which are all the points of a 3-D plane. Likewise, there is another dimension of time, which is time itself. And finally, there's an energy dimension, which is just the way particles behave when they're moving through space, time, and energy. This last dimension is the most mysterious one of all, because we still don't know how it got there!

Let's see how it would look like if our subatomic particles were able to travel through space, time, and energy in the same way as they do in reality. Suppose we had a cube (let's call it T) that contained subatomic clocks, which would be our time dimension. Let's also have a cube that contained energy, which would be our energy dimension. And then let's take a plane, which contains both our clocks and the energy cube. But this plane wouldn't be our space dimension because it's a 4-D plane, while clocks and energy are three-dimensional. Let's also call this plane the "tetrahedron". Now imagine that these three objects were created at the same time and at the same place. And as time went on, all these three objects gained energy.

Now let's consider that one of these objects fell off the plane, hit a wall, and was absorbed into space. Since this was a 4-D object (i.e., the clocks and energy inside T), it would experience a force on its sides that would cause it to start travelling in 4-D space. And if it managed to hit other objects and gain energy (which, as we discussed, is a very good thing), then it could then start travelling back across the space-time continuum at a much quicker rate than it did before.

So how does the four different dimensions of reality work?

Let me give you a little background on the four main dimensions. The four different dimensions of reality are:

Inertial - where objects such as our clocks are at rest
Mechanical - the objects and forces in this dimension are governed by the laws of mechanics
Gravitational - this dimension is caused by the gravitational field
Time - what we're experiencing right now is time on a timeline, which is an inertial frame (the clocks and energy inside T are the time dimension), but it's not a real time, since it's relative to the subatomic clocks
Space -